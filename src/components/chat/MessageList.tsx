...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div
        className="flex flex-col items-center justify-center min-h-[calc(100vh-2
         +00px)] px-4 text-center"
      >
  ...
  return (
    <div className="flex flex-col h-full px-4 py-6">
      <div className="flex flex-col flex-1 overflow-y-auto space-y-6 max-w-4xl mx-auto w-full justify-center">
